...
<html lang="en" style="height: 100%">
    <head>
        ...
        <script type="text/javascript">
            var Anywhere = {};
            Anywhere.urls = {};
            Anywhere.csrfToken = "jO2DiiSJkmS9zu7IUFAH7VivTsRwIkxZ9LaaDtO0ipm7zKIaIYu0YEvjZ9bESNVy";
        </script>
...
<li class="visible-xs"><a href="https://blog.pythonanywhere.com/" target="_parent" class="blog_link">Blog</a></li>
  ...
  <form class="form" action="" method="post"><input type="hidden" name="csrfmiddlewaretoken" value="jO2DiiSJkmS9zu7IUFAH7VivTsRwIkxZ9LaaDtO0ipm7zKIaIYu0YEvjZ9bESNVy">
    <table>
