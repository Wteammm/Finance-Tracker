...
<html lang="en" style="height: 100%">
    <head>
        ...
        <script type="text/javascript">
            var Anywhere = {};
            Anywhere.urls = {};
            Anywhere.csrfToken = "esq3FebfUCy8KmR4RPStyPE7EB2eD3y9hHmII28RcsvyjSgLFR5fw5sLQsEc6GCB";
        </script>
...
<li class="visible-xs"><a href="https://blog.pythonanywhere.com/" target="_parent" class="blog_link">Blog</a></li>
  ...
  <form class="form" action="" method="post"><input type="hidden" name="csrfmiddlewaretoken" value="esq3FebfUCy8KmR4RPStyPE7EB2eD3y9hHmII28RcsvyjSgLFR5fw5sLQsEc6GCB">
    <table>
